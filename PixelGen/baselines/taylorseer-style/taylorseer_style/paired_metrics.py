...
def evaluate_paired(
    *,
    ...
    validate_full_taylorseer_roles(reference_run, candidate_run)
    ...
    result: dict[str, Any] = {
        ...
        "candidate_interval": candidate_run["interval"],
        "candidate_max_order": candidate_run["max_order"],
        "candidate_coordinate_mode": candidate_run["coordinate_mode"],
