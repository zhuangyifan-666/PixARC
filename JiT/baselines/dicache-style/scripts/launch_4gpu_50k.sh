...
usage() {
  echo "Usage: $0 --config FILE --manifest FILE --output-root DIR --gpu-ids ID0,ID1,ID2,ID3 --release-gate FILE [--resume] [--nonfinal-proxy --expected-records N --expected-per-class N --expected-num-classes N]" >&2
}
