#!/usr/bin/env python3
"""Estimate Taylor attention/MLP factor-cache memory without loading a model."""
...
from taylorseer_style.memory import estimate_taylor_cache_bytes  # noqa: E402
from taylorseer_style.metadata import atomic_write_json  # noqa: E402
...
def main() -> None:
    ...
    report = estimate_taylor_cache_bytes(
        model,
    ...
    report.update(
        {
            ...
            "scope": "Taylor factor tensors only; excludes model, activations, allocator overhead, and CUDA workspaces",
        }
    )
