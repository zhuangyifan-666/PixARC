...
ImageNet-256 reference NPZ for every Full/SpeCa (and other baseline) comparison. It
...
The queued upstream Full may be usable here after complete-output validation
even if its initial noise cannot be paired.

## Strict paired fidelity

PSNR, SSIM, and LPIPS require manifest-backed Full and SpeCa runs with
