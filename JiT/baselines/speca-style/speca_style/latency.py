...
def benchmark_pair(
    ...
    *,
    ...
    speca["verification_overhead_ratio"] = (
        verification_ms / speca_batch_ms if speca_batch_ms > 0 else None
    )
    ...
    # Retain the requested label, but explicitly qualify the denominator below.
