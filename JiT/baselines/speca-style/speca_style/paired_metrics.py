...
def evaluate_paired(
    *,
    ...
    validate_full_speca_roles(reference_run, candidate_run)
    ...
    result: dict[str, Any] = {
        ...
        "candidate_speca_config_hash": candidate_run["speca_config_hash"],
        "candidate_speca_config": {
            field: candidate_run[field] for field in SPECA_CONFIG_FIELDS
        },
